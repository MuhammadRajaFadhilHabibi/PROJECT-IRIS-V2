...
<body class="bg-gray-200 dark:bg-blek-900">
    ...
    <div id="main-content" class="ml-[20%] p-8 bg-gray-200 min-h-screen">
        <div class="flex justify-between items-start">
            ...
            <div>
                ...
                <div class="relative bg-white p-6 rounded-2xl shadow-md border border-gray-300 w-[600px]">
                    ...
                    <div
                        class="absolute right-[-50px] bottom-[-50px] rounded-full w-[150px] h-[150px] bg-black overflow-hidden">
            ...
            <div class="flex flex-col items-end">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="text-red-500 font-bold bg-white py-2 px-4 rounded-full shadow hover:bg-red-100">
                        LOGOUT
                    </button>
                </form>
            </div>
        ...
        <div class="mt-8 bg-white p-6 rounded-2xl shadow-md border border-gray-300">
            <h2 class="text-2xl font-bold">Informasi Mahasiswa</h2>
